...
const countries = [
  ...
  'India', 'Singapore', 'Japan', 'South Korea', 'China', 'Brazil', 'Mexico',
  'Argentina', 'Chile', 'South Africa', 'Israel', 'UAE', 'Other'
];

const industries = [
  'SaaS/Software', 'E-commerce', 'FinTech', 'HealthTech', 'EdTech', 'Gaming',
  'AI/Machine Learning', 'Cybersecurity', 'Marketing Technology', 'HR Technology',
  'Real Estate Technology', 'Food & Beverage', 'Fashion & Lifestyle', 'Travel & Tourism',
  'Transportation & Logistics', 'Energy & CleanTech', 'Hardware & IoT', 'Biotech',
  'Media & Entertainment', 'Consulting & Services', 'Other'
];

const stages = [
  { value: 'idea', label: 'Idea', description: 'Early concept, researching the market' },
  { value: 'mvp', label: 'MVP', description: 'Building minimum viable product' },
  { value: 'revenue', label: 'Revenue', description: 'Making first sales, finding product-market fit' },
  { value: 'scaling', label: 'Scaling', description: 'Growing fast, expanding operations' },
];
        ...
        <CardContent className="space-y-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Select value={selectedCountry} onValueChange={(value) => setValue('country', value, { shouldValidate: true })}>
            ...
            <div className="space-y-2">
              ...
              <Select value={selectedIndustry} onValueChange={(value) => setValue('industry', value, { shouldValidate: true })}>
                <SelectTrigger className="border-slate-300 focus:border-blue-400 transition-all duration-200">
            ...
            <div className="space-y-4">
              ...
              >
                {stages.map((stage) => (
                  <div key={stage.value} className="flex items-center space-x-3 p-3 border border-slate-200 rounded-lg hover:border-blue-300 transition-colors cursor-pointer">
                    <RadioGroupItem value={stage.value} id={stage.value} />
                    <div className="flex-1">
                      <Label htmlFor={stage.value} className="font-medium text-slate-800 cursor-pointer">
                        {stage.label}
                      </Label>
            ...
            <div className="flex items-center justify-between p-4 bg-white/50 rounded-lg border border-slate-200">
              <div>
                <Label htmlFor="hasLaunched" className="text-slate-700 font-medium">
                  Have you launched your product yet? 🎉
                </Label>
                <p className="text-sm text-slate-600">This helps us understand your stage better</p>
              </div>
              <Switch
                id="hasLaunched"
                checked={hasLaunched}
